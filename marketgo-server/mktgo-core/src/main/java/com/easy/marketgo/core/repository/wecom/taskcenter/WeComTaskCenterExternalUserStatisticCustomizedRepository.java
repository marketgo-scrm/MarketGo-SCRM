 ...
 * Describe:
 */
public interface WeComTaskCenterExternalUserStatisticCustomizedRepository {
    ...
    @Slf4j
    class WeComTaskCenterExternalUserStatisticCustomizedRepositoryImpl implements WeComTaskCenterExternalUserStatisticCustomizedRepository {
        @Resource
