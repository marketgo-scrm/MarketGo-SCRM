 ...
 */
@Configuration
public class WeComCorpTagsCallbackMsgRabbitMqConfig extends AbstractRabbitConfig {

    @Bean
    public RabbitTemplate weComCorpTagsCallbackMsgAmqpTemplate() {
        ...
        rabbitAdmin.declareExchange(this.weComCorpTagsCallbackMsgExchange());
        ...
        rabbitAdmin.declareQueue(this.weComCorpTagsCallbackMsgQueue());
        rabbitAdmin.declareBinding(this.weComCorpTagsCallbackMsgBinging());
    ...
    @Bean
    public TopicExchange  weComCorpTagsCallbackMsgExchange() {

        TopicExchange topicExchange = new TopicExchange(RabbitMqConstants.EXCHANGE_NAME_DEFAULT_WECOM_CORP_TAG);
        topicExchange.setShouldDeclare(false);
        return topicExchange;
    }

    @Bean(name = "weComCorpTagsCallbackMsgListenerContainerFactory")
    public SimpleRabbitListenerContainerFactory weComCorpTagsCallbackMsgListenerContainerFactory() {
    ...
    @Bean
    public Queue weComCorpTagsCallbackMsgQueue() {
        ...
        return new Queue(RabbitMqConstants.QUEUE_NAME_WECOM_CORP_TAG, true, false, false, params);
    }

    @Bean
    public Binding weComCorpTagsCallbackMsgBinging() {

        return BindingBuilder.bind(this.weComCorpTagsCallbackMsgQueue()).to(this.weComCorpTagsCallbackMsgExchange())
                .with(RabbitMqConstants.ROUTING_KEY_WECOM_CORP_TAG);
    }
}
