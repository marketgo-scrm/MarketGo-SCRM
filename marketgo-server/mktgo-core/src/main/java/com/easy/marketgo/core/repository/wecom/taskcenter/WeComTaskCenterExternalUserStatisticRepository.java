 ...
 * Describe:
 */
public interface WeComTaskCenterExternalUserStatisticRepository extends CrudRepository<WeComMassTaskExternalUserStatisticEntity, Long>, WeComTaskCenterExternalUserStatisticCustomizedRepository {
    @Modifying
