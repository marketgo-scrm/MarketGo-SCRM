 ...
 */
@Configuration
public class WeComGroupTaskCenterRabbitMqConfig extends AbstractRabbitConfig {

    @Bean
    public RabbitTemplate weComGroupTaskCenterAmqpTemplate() {
        ...
        rabbitAdmin.declareExchange(this.weComGroupTaskCenterExchange());

        rabbitAdmin.declareQueue(this.weComGroupTaskCenterQueue());
        rabbitAdmin.declareBinding(this.weComGroupTaskCenterBinging());
    ...
    @Bean
    public TopicExchange weComGroupTaskCenterExchange() {

        TopicExchange topicExchange = new TopicExchange(RabbitMqConstants.EXCHANGE_NAME_WECOM_TASK_CENTER_GROUP);
        topicExchange.setShouldDeclare(false);
        return topicExchange;
    }

    @Bean(name = "weComGroupTaskCenterListenerContainerFactory")
    public SimpleRabbitListenerContainerFactory weComGroupTaskCenterListenerContainerFactory() {
    ...
    @Bean
    public Queue weComGroupTaskCenterQueue() {
        ...
        return new Queue(RabbitMqConstants.QUEUE_NAME_WECOM_TASK_CENTER_GROUP, true, false, false, params);
    }

    @Bean
    public Binding weComGroupTaskCenterBinging() {

        return BindingBuilder.bind(this.weComGroupTaskCenterQueue()).to(this.weComGroupTaskCenterExchange())
                .with(RabbitMqConstants.ROUTING_KEY_WECOM_TASK_CENTER_GROUP);
    }
