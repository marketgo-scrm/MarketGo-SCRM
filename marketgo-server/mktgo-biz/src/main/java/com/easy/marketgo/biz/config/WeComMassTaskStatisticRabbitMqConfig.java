 ...
 */
@Configuration
public class WeComMassTaskStatisticRabbitMqConfig extends AbstractRabbitConfig {

    @Bean
    public RabbitTemplate weComMassTaskStatisticAmqpTemplate() {
        ...
        rabbitAdmin.declareExchange(this.weComMassTaskStatisticExchange());

        rabbitAdmin.declareQueue(this.weComMassTaskStatisticQueue());
        rabbitAdmin.declareBinding(this.weComMassTaskStatisticBinging());
    ...
    @Bean
    public TopicExchange weComMassTaskStatisticExchange() {

        TopicExchange topicExchange = new TopicExchange(RabbitMqConstants.EXCHANGE_NAME_DEFAULT_WECOM_MASS_TASK_STATISTIC);
        topicExchange.setShouldDeclare(false);
        return topicExchange;
    }

    @Bean(name = "weComMassTaskStatisticListenerContainerFactory")
    public SimpleRabbitListenerContainerFactory weComMassTaskStatisticListenerContainerFactory() {
        RabbitProperties rabbitProperties = this.rabbitProperties();
        rabbitProperties.setVirtualHost(RabbitMqConstants.VIRTUAL_HOST_WECOM_MASS_TASK);
    ...
    @Bean
    public Queue weComMassTaskStatisticQueue() {
        ...
        return new Queue(RabbitMqConstants.QUEUE_NAME_WECOM_MASS_TASK_STATISTIC, true, false, false, params);
    }

    @Bean
    public Binding weComMassTaskStatisticBinging() {
        return BindingBuilder.bind(this.weComMassTaskStatisticQueue()).to(this.weComMassTaskStatisticExchange())
                .with(RabbitMqConstants.ROUTING_KEY_WECOM_MASS_TASK_STATISTIC);
    }
