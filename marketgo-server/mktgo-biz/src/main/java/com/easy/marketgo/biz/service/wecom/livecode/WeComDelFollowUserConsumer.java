 ...
 * @description : WeComDelFollowUserConsumer.java
 */
@Component
@Log4j2
public class WeComDelFollowUserConsumer {
    @Autowired
    private ChannelLiveCodeRefreshService liveCodeRefreshService;
    @RabbitListener(queues = {RabbitMqConstants.QUEUE_NAME_WECOM_DEL_FOLLOW_USER}, containerFactory =
