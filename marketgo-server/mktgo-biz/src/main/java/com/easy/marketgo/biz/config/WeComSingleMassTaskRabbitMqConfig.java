 ...
 */
@Configuration
public class WeComSingleMassTaskRabbitMqConfig extends AbstractRabbitConfig {

    @Bean
    public RabbitTemplate weComSingleMassTaskAmqpTemplate() {
        ...
        rabbitAdmin.declareExchange(this.weComSingleMassTaskExchange());

        rabbitAdmin.declareQueue(this.weComSingleMassTaskPublishQueue());
        rabbitAdmin.declareBinding(this.weComSingleMassTaskPublishBinging());
    ...
    @Bean
    public TopicExchange weComSingleMassTaskExchange() {

        TopicExchange topicExchange = new TopicExchange(RabbitMqConstants.EXCHANGE_NAME_DEFAULT_WECOM_MASS_TASK_SINGLE);
        topicExchange.setShouldDeclare(false);
        return topicExchange;
    }

    @Bean(name = "weComSingleMassTaskListenerContainerFactory")
    public SimpleRabbitListenerContainerFactory weComSingleMassTaskListenerContainerFactory() {
    ...
    @Bean
    public Queue weComSingleMassTaskPublishQueue() {
        ...
        return new Queue(RabbitMqConstants.QUEUE_NAME_WECOM_MASS_TASK_SINGLE, true, false, false, params);
    }

    @Bean
    public Binding weComSingleMassTaskPublishBinging() {

        return BindingBuilder.bind(this.weComSingleMassTaskPublishQueue()).to(this.weComSingleMassTaskExchange())
                .with(RabbitMqConstants.ROUTING_KEY_WECOM_MASS_TASK_SINGLE);
    }
