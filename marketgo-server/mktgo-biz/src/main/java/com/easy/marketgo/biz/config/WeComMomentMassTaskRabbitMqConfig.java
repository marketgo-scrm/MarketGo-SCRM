 ...
 */
@Configuration
public class WeComMomentMassTaskRabbitMqConfig extends AbstractRabbitConfig {

    @Bean
    public RabbitTemplate weComMomentMassTaskAmqpTemplate() {
        ...
        rabbitAdmin.declareExchange(this.weComMassTaskExchange());

        rabbitAdmin.declareQueue(this.weComMassTaskPublishQueue());
        rabbitAdmin.declareBinding(this.weComMassTaskPublishBinging());
    ...
    @Bean
    public TopicExchange weComMassTaskExchange() {

        TopicExchange topicExchange = new TopicExchange(RabbitMqConstants.EXCHANGE_NAME_DEFAULT_WECOM_MASS_TASK_MOMENT);
        topicExchange.setShouldDeclare(false);
        return topicExchange;
    }

    @Bean(name = "weComMomentMassTaskListenerContainerFactory")
    public SimpleRabbitListenerContainerFactory weComMomentMassTaskListenerContainerFactory() {
    ...
    @Bean
    public Queue weComMassTaskPublishQueue() {
        ...
        return new Queue(RabbitMqConstants.QUEUE_NAME_WECOM_MASS_TASK_MOMENT, true, false, false, params);
    }

    @Bean
    public Binding weComMassTaskPublishBinging() {

        return BindingBuilder.bind(this.weComMassTaskPublishQueue()).to(this.weComMassTaskExchange())
                .with(RabbitMqConstants.ROUTING_KEY_WECOM_MASS_TASK_MOMENT);
    }
