...
import com.easy.marketgo.react.service.WeComDelExtContactProducer;
 ...
 * @author : ssk
 * @version : v1.0
 * @date :  2022-08-16 20:19:33
 * @description : WeComDelExternalContactHandler.java
 */
@Slf4j
@Component
public class WeComDelExternalContactHandler extends AbstractWeComHandler {
    @Autowired
    private WeComDelExtContactProducer delExtContactProducer;
    /**
    ...
    public WeComXmlOutMessage handle(WeComXmlMessage message, Map<String, Object> context) throws CommonException {
        ...
        log.info("{}", message);
        log.info("{}", context);
        delExtContactProducer.produceRabbitMqMessage(message);
        return null;
    }
}
