<template>
  <div>
    <main-head title="任务中心" subtitle="如何配置待办任务侧边栏？" @ListenSubtitle="taskGudie">

      <el-form class="head-form" inline size="small" label='sss' label-width="0">
    ...
    <div class="search-content">
      <el-form :model="queryParams" size="mini" ref="queryForm" v-show="true" label-width="90px">
        <el-row>
          <el-col :span="5">
            <el-form-item label="任务名称">
              <el-input prefix-icon="el-icon-search" v-model="queryParams.keyword" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="添加时间">
              <el-date-picker style="width: 100%" type="daterange" v-model="queryParams.times" align="right"
          ...
          <el-col :span="5">
            <el-form-item label="创建人">
              ...
              <el-select v-model="queryParams.create_user_ids" multiple placeholder="请选择创建人">
                <el-option v-for="item in creators" :key="item.creatorId" :label="item.creatorName"
        ...
        <el-row>
          <el-col :span="5">
            <el-form-item label="任务状态">
              <el-select style="width: 100%" multiple collapse-tags v-model="queryParams.statuses" placeholder="请选择"
                clearable>
                <el-option v-for="(dict, index) in statusesOption" :key="index" :label="dict.label"
                  :value="dict.value" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="任务类型">
              <el-select style="width: 100%" collapse-tags v-model="queryParams.task_type" placeholder="请选择" clearable>
                <el-option v-for="(dict, index) in task_typeOption" :key="index" :label="dict.label"
                  :value="dict.value" />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label-width="20px">
              <el-button type="primary" icon="" size="mini" round @click="handleQuery">筛选
              </el-button>
              <el-button icon="" round size="mini" @click="resetQuery">重置
              </el-button>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog title="选择您要创建的任务类型" :visible.sync="dialogFormVisible">
      <div class="typeBox">
        <div class="item " :class="khChick ? 'active' : ''" @click="khChick = true; khqChick = false; pyqChick = false">
          <div class="icon"></div>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false" icon="" size="mini" round>取 消</el-button>
        <el-button type="primary" @click="addJump()" icon="" round size="mini">创 建</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    taskGudie() {
      this.$router.push('/index/task-side-guide')
    },
    toAdd() {
      console.log(111)
