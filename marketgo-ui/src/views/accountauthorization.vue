        ...
        <el-scrollbar ref="scroll" style="height: 100%">
          <div class="stepin">
            ...
            <div v-show="chosedata.dicts">
              <div
                class="dictlist"
                v-for="(item, index) in chosedata.dicts"
                :key="index + 'a'"
              >
                <span>{{ index + 1 }} 
                ...
                <el-form-item label="EncodingAESKey" prop="encodingAesKey">
                  <!-- <el-row>
                    <el-col :span="10"> -->
                      <el-input
                        disabled
                        v-model="contacts.encodingAesKey"
                    ...
                    <el-col :span="3" :offset="1"> -->
                      <el-button
                        ...
                        round
                         class='copys'
                        @click="copytext(contacts.encodingAesKey)"
                        >复制</el-button
                      >
                    <!-- </el-col>
                  </el-row> -->
            ...
            <el-form
            label-position="left"
              v-show="nowtype == 6 || nowtype == 7 || nowtype == 8"
              :model="externalUser"
              size="small"
              ref="externalUser"
              :rules="externalUserrules"
              label-width="110px"
            >
              <template v-if="nowtype == 6">
                <el-form-item label="客户联系Secret" prop="secret">
                  <el-input
                    v-model="externalUser.secret"
                    placeholder="客户联系Secret"
                    clearable
                  />
                </el-form-item>
              </template>
                  ...
                  <!-- <el-row>
                    ...
                    <el-col :span="3" :offset="1"> -->
                      <el-button
                        ...
                        round
                         class='copys'
                        @click="copytext(externalUser.url)"
                        >复制</el-button
                      >
                    <!-- </el-col>
                  </el-row> -->
                  ...
                  <!-- <el-row>
                    ...
                    <el-col :span="3" :offset="1"> -->
                      <el-button
                        ...
                        round
                         class='copys'
                        @click="copytext(externalUser.token)"
                        >复制</el-button
                      >
                    <!-- </el-col>
                  </el-row> -->
                ...
                <el-form-item label="EncodingAESKey" prop="encodingAesKey">
                  <!-- <el-row>
                    <el-col :span="10"> -->
                      <el-input
                        disabled
                        v-model="externalUser.encodingAesKey"
                        placeholder="请输入EncodingAESKey"
                        clearable
                      />
                    <!-- </el-col>
                    <el-col :span="3" :offset="1"> -->
                      <el-button
                        ...
                        round
                         class='copys'
                        @click="copytext(externalUser.encodingAesKey)"
                        >复制</el-button
                      >
                    <!-- </el-col>
                  </el-row> -->
            ...
            <div class="btns">
              <el-button size="small" round @click="prive" v-if="nowtype != 0"
                >返回上一步</el-button
              >
              <el-button
              round
  ...
  data() {
    return {
      ...
      activities: [
        ...
        //   content: "配置聊天侧边栏",
        //   children: [
        //     { name: "配置网页授权JS-SDK", type: 9 },
        //     { name: "配置客户画像和群画像", type: 10 },
        //     { name: "配置素材库", type: 11 },
        //   ],
        // },
      ],
  ...
  methods: {
    ...
    async gethttps() {
      let data = await this.$http.get(
        `mktgo/wecom/corp/config?project_id=${this.project_id}&corp_id=${this.agent.corpId}`
      );
      if (data.code === 0) {
