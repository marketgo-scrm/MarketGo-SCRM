...
**新发布release 0.6.0的版本，说明如下：**

新增功能：

1、**客户群活码**--创建基于多个客户群创建活码，当客户群人数达到上限可以自动创建新群；

2、**客户欢迎语**--可以创建基于一个员工或者多个员工的欢迎语，当员工添加新客户时发送欢迎语给客户。

3、**客户群欢迎语**--创建客户群的欢迎语，创建后可以通知群主，群主可以根据群的特点选择合适的欢迎语内容。
