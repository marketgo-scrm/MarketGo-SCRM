...
**新发布release 0.4.0的版本，说明如下：**

新增功能：

1、添加内容中心功能，包含话术库，问答库等；

2、话术库可以创建基于文字，图片，H5，小程序等信息的话术，并且可以设置标签，基于部门，岗位等维度添加不同的标签；  

3、问答库的内容也是包含文字，图片，H5，小程序，可以设置关键词，关键词体现了问题使用场景或者问题中的核心词。
